...
public class StateEditor extends State {
	...
	/**
	 * Set the type of object to be placed by the marker
	 * Called by the EditorFrame (Dot, Powerup, Teleport buttons)
	 * 
	 * @param t Type of object (from GameObject statics)
	 */
	...
	/**
	 * Set the type of wall to be placed by the marker
	 * Called by the EditorFrame Wall button
	 * 
	 * @param t Type of wall (from GameObject statics)
	 */
	...
	/**
	 * Set the type of wall to be placed by the marker
	 * Called by the EditorFrame Add Ghost button
	 * 
	 * @param t Type of wall (from GameObject statics)
	 */
	 ...
	 * 
	 * @param t True if trapped in the spawn-jail
	 */
	...
	/**
	 * Set the teleport destination, used to aid a teleport drop
	 * Called in EditorFrame by the Teleport add button
	 * 
	 * @param x destination coordinate X of the next teleport
	 * @param y destination coordinate Y of the next teleport
	 */
	...
	/**
	 * Logic of the editor processed here: Rendering, input, and object placement. Called in the mainThreadLoop
	 * 
	 * @see State#logic()
	 */
	@Override
	...
	/**
	 * Termination of the StateEdtior. Set references stored by the StateEditor as null
	 * 
	 * @see State#end()
	 */
	@Override
